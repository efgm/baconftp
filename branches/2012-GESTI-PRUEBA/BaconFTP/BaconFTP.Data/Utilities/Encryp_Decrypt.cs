...
{
    // Encrypt a string into a string using a password -> Llamar esta.
    ...
    public static string Encrypt(string Password, string clearText)
    {
        ...
        PasswordDeriveBytes pdb = new PasswordDeriveBytes(clearText,
    ...
    public static string Decrypt(string Password, string cipherText)
    {
        ...
        // We are using salt to make it harder to guess our key using a dictionary attack -
        // trying to guess a password by enumerating all possible words.
        PasswordDeriveBytes pdb = new PasswordDeriveBytes(cipherText,
                    new byte[] { 0x49, 0x76, 0x61, 0x6e, 0x20, 0x4d, 0x65, 0x64, 0x76, 0x65, 0x64, 0x65, 0x76 });
